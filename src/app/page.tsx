      ...
      <MainLayout>
        <div className="max-w-4xl mx-auto">
          <div className="bg-teal-50 border border-teal-200 rounded-lg p-4 mb-6">
            <p className="text-teal-800 mb-2">
              This app is a part of the project deliverables for the BlueDot Impact course on <a href="https://aisafetyfundamentals.com/"
                className="text-teal-600 hover:text-teal-800 underline"
                target="_blank"
                rel="noopener noreferrer">AI Safety Fundamentals.</a>
            </p>
            <p className="text-teal-700">
              Read the experiment report:{' '}
              <a
                href="https://fiddien.com/posts/ai-debate/"
                className="text-teal-600 hover:text-teal-800 underline"
                target="_blank"
          ...
          <div className="bg-teal-50 border border-teal-200 rounded-lg p-4 mb-6">
            <h3 className="font-medium text-teal-800 mb-2">How the Debate Works:</h3>
            <ol className="list-decimal list-inside text-teal-700 space-y-2">
              <li>First, review the scenario details and question from the BoardgameQA dataset, or create your own</li>
              <li>Assign positions to Debater A and B from the available options</li>
              <li>Start the debate by having models argue their assigned positions</li>
              <li>A judge model will evaluate the debate and determine the winner</li>
            </ol>

            <p className="text-teal-700 mt-2">You can change the scenario, reset the debate, and download the result at any time.
            The prompts are also editable to customize the debate experience. Make sure to keep the variables enclosed in curly braces (&#123;&#125;).
            The default prompts instruct the models to "think internally" which you can see in the <i>Thinking Process</i> section on each generated responses.
            Enjoy!</p>
          </div>
        ...
        <footer className="text-center py-4 text-sm text-gray-500 mt-8 border-t">
          <p className="flex items-center justify-center gap-2">
            ...
            <a href="https://github.com/fiddien/ai-debate-simulator" className="inline-flex hover:text-gray-700" aria-label="GitHub Profile">
